...
public class Busqueda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        opc = new javax.swing.JComboBox<String>();
        ...
        opc.setFont(new java.awt.Font("Traditional Arabic", 0, 18)); // NOI18N
        opc.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Codigo", "Nombre" }));
        ...
        jLabel2.setText("Escriba el producto:");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(opc, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(codigo))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      if (codigo.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "El campo de codigo està vacìo");
        }else{
        String opcion = opc.getSelectedItem().toString();
      String dato = codigo.getText();
      busqueda(opcion, dato);
    ...
    private void busqueda(String opcion, String dato) {
            ...
            case "Codigo":
                 try (Scanner lector = new Scanner(archivo)) {
                    while (lector.hasNextLine()) {
                        ...
                        if (codigo == Integer.parseInt(dato)) {
            ...
            case "Nombre":
                try (Scanner lector = new Scanner(archivo)) {
                    while (lector.hasNextLine()) {
                        ...
                        int cant = Integer.parseInt(st.nextToken());
                        float precio = Float.parseFloat( st.nextToken());
                        int resultado = nombre.indexOf(dato);
